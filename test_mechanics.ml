...
let special_start = start_game 6 7 2 4 
    [ANSITerminal.yellow; ANSITerminal.red] 2;;

let small_special_start = start_game 5 5 3 3 
    [ANSITerminal.yellow; ANSITerminal.red] 2;;

let empty_board = [[]; []; []; []; []; []; []];;

let win_tests = [
  make_win_test "col win" start [4;4;3;5;5;2;2;4;4;2;6;5;5;7;7;2;6;1;3;2;3;4;3] 
    1 3 true;
  make_win_test "col2 win" start [3;4;3;7;3;2;3] 1 3 true;
  make_win_test "col3 win" start [4;4;3;5;2;5;3;5;4;6;4;1;2;7;6;7;1;6;4;5] 
    2 5 true;
  make_win_test "col4 win" start 
    [4;4;3;6;1;2;4;5;7;4;4;7;6;4;5;5;5;6;3;7;2;6;3;1;3] 1 3 true;
  ...
  make_win_test "row8 win" start [4;4;5;3;6;7;6;2;2;1;2;1;4;4;1;3;4;1;1;1;3] 
    1 3 true;
  make_win_test "row9 win" start [4;4;3;6;7;7;5;2;3;5;1;6] 2 6 true;
  make_win_test "row10 win" start [4;4;7;5;5;3;6;5;4;4;7;6;2;3;1;4;6;2;6;1] 
    2 1 true;
  ...
  make_win_test "lr5 diag win" start [3;1;3;4;6;4;4;6;6;5;6;5;5;7;6;3;5] 
    1 5 true;
  make_win_test "lr6 diag win" start [3;4;5;6;4;5;3;4;3;3] 2 3 true;
  make_win_test "lr7 diag win" start [4;4;3;7;4;5;6;6;5;7;2;1;3;2;1;5;1;1;5] 
    1 5 true;
  make_win_test "lr8 diag win" start 
    [4;4;3;5;2;1;4;3;5;2;1;4;3;5;2;1;3;3;2;2;4] 1 4 true;
  ...
  make_win_test "rl3 diag win" start [3;4;7;6;5;5;5;7;6;3;3;3;3;4;7;4;4] 
    1 4 true;
  ...
  make_win_test "rl6 diag win" start 
    [4;4;4;4;3;7;1;2;7;1;3;5;4;3;3;2;5;5;3;7;3;5;6] 1 6 true;
  make_win_test "rl7 diag win" start 
    [4;4;3;1;5;4;4;6;1;6;1;2;5;6;4;4;6;6;1;2;3;5;2] 1 2 true;
  make_win_test "rl8 diag win" start 
    [4;4;3;5;2;1;4;3;5;2;1;3;4;3;1;4;3;2;2;4;5;1;5;5;5;3;6;6;6;2;2] 1 2 true;
  make_win_test "rl9 diag win" start 
    [4;4;3;5;2;1;4;3;5;2;1;3;4;3;3;7;3;6;5;6;1;7;6;2;2;2;2] 1 2 true;
  ...
  make_win_test "no8 win" start 
    [4;4;3;5;2;1;4;3;5;2;1;3;4;3;5;3;4;4;6;2;2;2;1;1;2;3;5;5;5;1;1;7;
     6;6;6;6;7;6;7;7;7;7] 2 7 false;
  make_win_test "no9 win" start [1;1;2;2;1;1;1;1;3;2] 1 2 false;
]

let draw_tests = [
  make_draw_test "no draw" start [1;1;2;2;1;1;1;1;3;2] false;
  make_draw_test "no draw2" start 
    [4;4;3;5;2;1;4;3;5;2;1;3;4;3;1;4;3;2;2;4;5;1;5;5;5;3;6;6;6;2;2] false;
  make_draw_test "draw" start 
    [4;4;3;5;2;1;4;3;5;2;1;3;4;3;5;3;4;4;6;2;2;2;1;1;2;3;5;5;5;1;1;7;6;6;6;
     6;7;6;7;7;7;7] true;
]

let special_win_tests = [
  make_special_win_test "no special pieces" start 
    [(1,"n");(1,"n");(2,"n");(2,"n");(1,"n");(1,"n");(1,"n");(1,"n");
     (3,"n");(2,"n")] 1 2 false;
  make_special_win_test "anvil no win" special_start 
    [(1,"n");(1,"n");(1,"a");(2,"n");(1,"n")] 1 1 false;
  make_special_win_test "wall no win" special_start 
    [(1,"n");(1,"n");(1,"w");(2,"n");(1,"n")] 1 1 false;
  make_special_win_test "normal no win" small_special_start 
    [(1,"n");(2,"n");(1,"n");(1,"n");(2,"n");(1,"n");(2,"n")] 1 2 false;
  make_special_win_test "anvil win" small_special_start 
    [(1,"n");(2,"n");(1,"n");(1,"n");(2,"n");(1,"a");(2,"n");(3,"n");
     (1,"n");(3,"n");(3,"n");(1,"n")] 1 2 false;
  make_special_win_test "anvil p2 win" small_special_start 
    [(1,"n");(2,"n");(1,"n");(1,"n");(2,"n");(1,"a");(2,"n");(3,"n");
     (1,"n");(1,"n");(4,"n")] 2 4 true; 
  make_special_win_test "wall p2 win" small_special_start 
    [(1,"n");(1,"n");(1,"n");(2,"w");(1,"n");(2,"n");(3,"n");(4,"n");(3,"n")] 
    2 3 true;
  make_special_win_test "wall p1 win" small_special_start 
    [(1,"n");(1,"n");(1,"w");(5,"n");(2,"n");(2,"n");(4,"n");(3,"n")] 1 3 true;
]
